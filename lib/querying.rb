...
def select_value_and_count_of_most_prolific_species
  "SELECT characters.species, SUM(characters.species) AS character_count FROM characters GROUP BY characters.species ORDER BY characters.species DESC LIMIT 1;"
end
